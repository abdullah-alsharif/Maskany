...
const REVIEWS: ReviewSeed[] = [
  ...
  { property_key: 'riyadh-apartment-1', user_key: 'owner-layla', rating: '4.5', comment: 'Excellent location and very clean apartment.' },
  { property_key: 'riyadh-apartment-1', user_key: 'owner-sara', rating: '4.0', comment: 'Good value for money in a prime area.' },
  { property_key: 'riyadh-apartment-1', user_key: 'dev-owner', rating: '5.0', comment: 'Perfect for business trips — highly recommend.' },
  { property_key: 'riyadh-apartment-1', user_key: 'browser-dana', rating: '3.5', comment: 'Decent place, parking was a bit tricky.' },
  { property_key: 'riyadh-apartment-1', user_key: 'browser-nura', rating: '5.0', comment: 'Loved the modern finishes and natural light.' },
  { property_key: 'riyadh-apartment-1', user_key: 'browser-faisal', rating: '4.0', comment: 'Clean, spacious, and close to restaurants.' },
  { property_key: 'riyadh-apartment-1', user_key: 'browser-hessa', rating: '4.5', comment: 'The host was very responsive and helpful.' },
  { property_key: 'riyadh-apartment-1', user_key: 'browser-majid', rating: '3.0', comment: 'Average stay, AC needed servicing.' },
  { property_key: 'riyadh-apartment-1', user_key: 'browser-nouf', rating: '5.0', comment: 'Beautiful apartment, exactly as pictured.' },
  { property_key: 'riyadh-apartment-1', user_key: 'browser-sultan', rating: '4.0', comment: 'Great view and comfortable beds.' },
  { property_key: 'riyadh-apartment-1', user_key: 'browser-reema', rating: '3.5', comment: 'Good location but a bit noisy at night.' },
  { property_key: 'riyadh-apartment-1', user_key: 'browser-turki', rating: '4.0', comment: 'Convenient check-in process and well-equipped kitchen.' },
];
